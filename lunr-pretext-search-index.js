...
},
{
  ...
  "number": "5.6.2",
  "title": "",
  "body": " A coupled mass-spring system showing unstretched, equilibrium, motion, and coordinate-axis configurations.     "
},
{
  "id": "subsec-Coupled-Spring-Mass-Systems-7",
  "level": "2",
  "url": "sec-5-6.html#subsec-Coupled-Spring-Mass-Systems-7",
  "type": "Example",
  "number": "5.6.3",
  "title": "",
  "body": " Solve the second-order coupled system of linear differential equations with initial conditions   Taking the Laplace transform yields   Using the given initial conditions yields Solving for and gives   Partial fraction decomposition of and are   Taking the inverse Laplace transform yields which render the solutions of the given initial value problem .   Graphs of the solutions and      "
},
{
  "id": "fig-lrc-circuit",
  "level": "2",
